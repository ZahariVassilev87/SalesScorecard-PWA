...
class NotificationService {
  private vapidPublicKey = 'BObSOgKLv2p6nSlc6gawMFGvyr-tL_v6x2C7A9ZSStYETKUzUA205tTuRfWh9Y1LD5rtoGY75xOaLv9fX3r-Tgc'; // VAPID key for production

  constructor() {
    console.log('🔍 [DEBUG] NotificationService constructor - VAPID key:', this.vapidPublicKey);
    console.log('🔍 [DEBUG] NEW VERSION 1.2.3 - Push notifications ENABLED with timeout fix');
  }

  // Helper method to get service worker with timeout
  private async getServiceWorkerRegistration(timeoutMs: number = 3000): Promise<ServiceWorkerRegistration | null> {
    try {
